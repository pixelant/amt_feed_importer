# -*- coding: utf-8 -*-
#
# Feed Importer documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 14 Jan 2015 11:38:57 +0100.
#
...
project = u'Feed Importer'
copyright = u'2015, Krzysztof Kasprzyca'
...
htmlhelp_basename = 'amt_feed_importerdoc'
...
latex_documents = [
    ('Index', 'amt_feed_importer.tex', u'Feed Importer',
     u'Krzysztof Kasprzyca', 'manual'),
]
...
pdf_documents = [
    ('Index', 'amt_feed_importer', u'Feed Importer',
     u'Krzysztof Kasprzyca'),
]
...
texinfo_documents = [
    ('Index', 'amt_feed_importer', u'Feed Importer',
     u'Krzysztof Kasprzyca', 'Feed Importer', 'One line description of project.',
     'Miscellaneous'),
]
