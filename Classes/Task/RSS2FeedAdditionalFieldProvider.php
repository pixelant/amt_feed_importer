...
class RSS2FeedAdditionalFieldProvider extends \AMT\AmtFeedImporter\Task\AbstractFeedAdditionalFieldProvider {
	 ...
	 * 
	 * @param \AMT\AmtFeedImporter\Task\RSS2ImportTask $task
	 * @return void
